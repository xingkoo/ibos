...
// 核心模块,安装顺序有限制
$coreModules = array( 'main', 'dashboard', 'message', 'user', 'department', 'position', 'organization' );
// 核心依赖模块
$sysDependModule = array( 'weibo' );
// 系统模块，把核心模块和核心依赖模块组合
$sysModules = array( 'main', 'dashboard', 'message', 'user', 'department', 'position', 'organization', 'weibo' );
// 要检测的函数
$funcItems = array(
