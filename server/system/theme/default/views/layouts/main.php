			...
			<div class="header" id="header">
				<div class="wrap">		
					<div class="logo">
						...
						<a href="<?php echo Ibos::app()->setting->get("siteurl");?>">
						<?php $logourl = !empty($unit["logourl"]) ? $unit["logourl"] : STATICURL . "/image/logo.png";?>
						<img src="<?php echo $logourl;?>?<?php echo VERHASH;?>" alt="IBOS"></a>
					</div>
					<!-- Nav -->
						...
						<div class="nvw">
							<ul class="nv nl" id="nv">
								...
								<?php
									...
									$nav["url"] = UrlUtil::getUrl($nav["url"]);
								?>
				...
				<div class="uil-card" id="user_login_card" style="display:none;">
					...
					<div class="uil-card-body">
						...
						<div class="progress" title="Progress-bar">
							<div class="progress-bar <?php if (90 < Ibos::app()->user->upgrade_percent) : ?>progress-bar-danger<?php else : ?>progress-bar-success<?php endif; ?>" style="width: <?php echo Ibos::app()->user->upgrade_percent;?>%;"></div>
						</div>
						<div class="btn-group btn-group-justified">
							<a href="<?php echo Ibos::app()->user->space_url;?>" class="btn"><i class="om-user"></i>个人中心</a>
							<?php if (Ibos::app()->user->isadministrator) : ?>
								<a class="btn" target="_blank" href="<?php echo Ibos::app()->urlManager->createUrl("dashboard/");?>" ><i class="om-key"></i><?php echo Ibos::lang("Control center", "default");?></a>
							<?php endif; ?>
