<div class="ct">
	<div class="clearfix">
		<h1 class="mt"><?php echo $lang["Vote"];?>
</h1>
	</div>
	<div>
			...
			<div class="ctb">
				...
				<div class="ctbw">
					<div class="control-group">
						...
						<div class="controls">
							<input type="checkbox" name="votethumbenable" value='1' id="thumb_operate" data-toggle="switch" class="visi-hidden" <?php if ($votethumbenable) echo "checked"; ?> >
						</div>
					</div>
					<div class="control-group thumb-operate" style="<?php if ($votethumbenable) echo "display:block";?><?php if (!$votethumbenable) echo "display:none";?>">
