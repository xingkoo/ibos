...
<div id="vote" class="vote mb">
    <ul class="nav nav-tabs nav-tabs-large nav-justified" id="vote_tab">
        <li class="<?php if (empty($voteData)) echo "active"; ?><?php if (!empty($voteData) && ($voteData["vote"]["type"] == 1)) echo "active"; ?>">
        ...
        <li class="<?php if (!empty($voteData) && ($voteData["vote"]["type"] == 2)) echo "active"; ?>">
    ...
    <div class="nav-content bdrb">
		<?php if (isset($voteData) && (0 < count($voteData))) : ?>
							...
							<div class="row">
								<div class="span3">
									<select name="vote[deadlineType]" id="vote_txt_deadline">
										<option value="0" <?php if ($voteData["vote"]["deadlinetype"] == 0) echo "selected"; ?>><?php echo Ibos::lang("Custom", "vote.default");?></option>
										<option value="1" <?php if ($voteData["vote"]["deadlinetype"] == 1) echo "selected"; ?>><?php echo Ibos::lang("One week", "date");?></option>
										<option value="2" <?php if ($voteData["vote"]["deadlinetype"] == 2) echo "selected"; ?>><?php echo Ibos::lang("One month", "date");?></option>
										<option value="3" <?php if ($voteData["vote"]["deadlinetype"] == 3) echo "selected"; ?>><?php echo Ibos::lang("Half of a year", "date");?></option>
										<option value="4" <?php if ($voteData["vote"]["deadlinetype"] == 4) echo "selected"; ?>><?php echo Ibos::lang("One year", "date");?></option>
									</select>
								</div>
								<div class="span6">
					...
					<div class="control-group">
						...
						<div class="controls">
							<label class="radio radio-inline">
								<input type="radio" name="vote[isvisible]" value="1" <?php if ($voteData["vote"]["isvisible"] == 1) echo "checked"; ?> >
								<?php echo Ibos::lang("After the vote visible", "vote.default");?>
							</label>
							<label class="radio radio-inline">
								<input type="radio" name="vote[isvisible]" value="0" <?php if ($voteData["vote"]["isvisible"] == 0) echo "checked"; ?> >
			...
			<?php elseif ($voteData["vote"]["type"] == 2) : ?>
				<!-- 文字投票 -->
				...
				<div id="vote_pic" class="ct ctform form-compact" style="display:none;">
					...
					<div class="control-group">
						...
						<div class="controls">
							<label class="radio radio-inline">
								<input type="radio" name="imageVote[isvisible]" value="1" <?php if ($voteData["vote"]["isvisible"] == 1) echo "checked"; ?>>
								<?php echo Ibos::lang("After the vote visible", "vote.default");?>
							</label>
							<label class="radio radio-inline">
								<input type="radio" name="imageVote[isvisible]" value="0" <?php if ($voteData["vote"]["isvisible"] == 0) echo "checked"; ?>>
								<?php echo Ibos::lang("Any visible", "vote.default");?>
							</label>
						</div>
					</div>
...
<script type="text/javascript">
	(function() {
		...
		// 还原投票数据
		$(function() {
<?php if (isset($voteData["voteItemList"]) && (0 < count($voteData["voteItemList"]))) : ?>
