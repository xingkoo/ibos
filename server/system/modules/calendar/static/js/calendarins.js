...
var Cld = {
	...
	_parseEvtToParam: function(evt){
		...
		return {
			...
			Subject: evt.title,
			CalendarStartTime: evt.start.format(this.DATETIME_FORMAT),
			CalendarEndTime: evt.end ? evt.end.format(this.DATETIME_FORMAT) : null,
...
$(function(){
	var settings = {
		...
		minTime: Ibos.app.g("calSettings").minTime,//设置显示的时间从几点开始
		maxTime: Ibos.app.g("calSettings").maxTime,//设置显示的时间从几天结束
