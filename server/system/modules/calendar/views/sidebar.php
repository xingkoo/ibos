	...
	<div class="sbb sbbl sbbf">
		<ul class="nav nav-strip nav-stacked">
			<li class="active">
				...
				<div class="sbb sbbf">
					<ul class="aside-list">
						<li <?php if ( Yii::app()->getController()->getId() == 'schedule' ): ?>class="active"<?php endif; ?>>
							<a href="<?php echo $this->createUrl( 'schedule/index' ); ?>"><i class="o-cal-calendar"></i>
								<?php echo $lang['Schedule']; ?>
							</a>
						</li>
						<li <?php if ( Yii::app()->getController()->getId() == 'task' ): ?>class="active"<?php endif; ?>>
							<a href="<?php echo $this->createUrl( 'task/index' ); ?>"><i class="o-cal-todo"></i>
								<?php echo $lang['Task']; ?>
							</a>
						</li>
						<li <?php if ( Yii::app()->getController()->getId() == 'loop' ): ?>class="active"<?php endif; ?>>
