...
<script>
	Ibos.app.s({
		calSettings : {
			// 日程开始时间
			minTime: new moment(Ibos.date.numberToTime(<?php echo CalendarUtil::getSetupStartTime( Ibos::app()->user->uid ); ?>), "HH:mm"),
			// 日程结束时间
			maxTime: new moment(Ibos.date.numberToTime(<?php echo CalendarUtil::getSetupEndTime( Ibos::app()->user->uid ); ?>), "HH:mm"),
