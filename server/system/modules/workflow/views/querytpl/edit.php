	...
	<form action="javascript:;" class="form-horizontal form-narrow" id="advanced_search_form">
		...
		<div class="fill">
			...
			<div id="primary_param">
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="flow_query_type" class="span4">
							<option value="all" <?php if ($tpl["flow"]["flowquerytype"] == "all") echo "selected";?> ><?php echo $lang["Query scope all"];?></option>
							<option value="1" <?php if ($tpl["flow"]["flowquerytype"] == "1") echo "selected";?> ><?php echo $lang["Query scope 1"];?></option>
							<option value="2" <?php if ($tpl["flow"]["flowquerytype"] == "2") echo "selected";?> ><?php echo $lang["Query scope 2"];?></option>
							<option value="3" <?php if ($tpl["flow"]["flowquerytype"] == "3") echo "selected";?> ><?php echo $lang["Query scope 3"];?></option>
						</select>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="flow_status" data-type="flow_status" class="span4">
							<option value="all" <?php if ($tpl["flow"]["flowstatus"] == "all") echo "selected";?> ><?php echo $lang["All"];?></option>
							<option value="1" <?php if ($tpl["flow"]["flowstatus"] == "1") echo "selected";?> ><?php echo $lang["Being performed"];?></option>
							<option value="0" <?php if ($tpl["flow"]["flowstatus"] == "0") echo "selected";?> ><?php echo $lang["Has ended"];?></option>
						</select>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group" id="flow_end_date_scope"<?php if ($tpl["flow"]["flowstatus"] !== "0") echo ' style="display: none;"';?> >
					...
					<div class="controls">
						<select name="group_field" class="span3">
							<?php foreach (array_merge($deftitle, $title) as $index => $value ) : ?>
								<option value="<?php echo $value["key"];?>" <?php if ($value["key"] == $tpl["group"]["field"]) echo "selected";?> ><?php echo $value["title"];?></option>
							<?php endforeach; ?>
						</select>
						<select name="group_sort" id="" class="span2">
							<option value="asc" <?php if ($tpl["group"]["order"] == "asc") echo "selected";?> ><?php echo $lang["Ascending"];?></option>
							<option value="desc" <?php if ($tpl["group"]["order"] == "desc") echo "selected";?> ><?php echo $lang["Descending"];?></option>
						</select>
					</div>
				</div>
				<div class="control-group">
