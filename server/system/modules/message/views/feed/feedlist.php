		...
		<div class="wb-ifview-top rdt <?php if ( $fd['module'] == 'weibo' ): ?>bdbs<?php else: ?>rdb<?php endif; ?> ">
			...
			<div class="wb-info-ads clearfix">
				<div class="wb-info-from pull-left">
					<a href="<?php echo Ibos::app()->urlManager->createUrl( 'weibo/personal/feed', array( 'uid' => $fd['uid'], 'feedid' => $fd['feedid'] ) ); ?>"><?php echo ConvertUtil::formatDate( $fd['ctime'], 'n月d日H:i' ); ?></a>
