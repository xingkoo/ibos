				...
				<div class="msg-pm-detail-header">
					<div class="band band-primary">
						<div class="avatar-box pull-right">
							<a target='_blank' data-toggle='usercard' data-param='uid=<?php echo  Yii::app()->user->uid; ?>' href="<?php echo Yii::app()->user->space_url; ?>" class="avatar-circle">
								<img class="mbm" src="<?php echo Yii::app()->user->avatar_middle; ?>" >
							</a>
						</div>
