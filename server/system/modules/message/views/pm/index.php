						...
						<?php foreach ( $list as $row ): ?>
							<li class="main-list-item curp" id="pm_<?php echo $row['listid']; ?>" data-url="id=<?php echo $row['listid']; ?>&type=<?php echo $row['type']; ?>">
								<div class="avatar-box pull-left posr">
									<?php if($row['lastmessage']['touid'][0] == Yii::app()->user->uid): ?>
								...
								<div class="main-list-item-body">
									<div>
										<p class="mb">
											<?php if($row['lastmessage']['fromuid']==Yii::app()->user->uid){ ?>
										...
										<div>
											<div class="pull-left">
												...
												<span class="tcm fss"><?php echo ConvertUtil::formatDate( $row['listctime'], 'u' ); ?></span>
...
<script>
	Ibos.app.setPageParam({
		'dataUid': '<?php echo StringUtil::wrapId( Yii::app()->user->uid ) ?>'
	})
