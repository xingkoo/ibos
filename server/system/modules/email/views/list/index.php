						...
						<tbody>
							...
							<?php foreach ( $list as $data ): ?>
								...
								<tr id="list_tr_<?php echo $id; ?>">
									...
									<td width="120"><div class="fss"><?php echo ConvertUtil::formatDate( $data['sendtime'], 'u' ); ?></div></td>
...
<script>
	(function() {
		...
		$pageNumCtrl.on("select", function(evt) {
			window.location.href = Ibos.app.url('email/list/index', { condition: '<?php echo $op; ?>', pagesize: evt.selected });
		});
	})();
