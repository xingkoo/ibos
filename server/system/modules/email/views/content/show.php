			...
			<div class="mal-view">
				...
				<div class="ctb bglb media bdbs">
					<a data-toggle="usercard" data-param="uid=<?php echo $email['fromid']; ?>" href="<?php echo Ibos::app()->urlManager->createUrl( 'user/home/index', array( 'uid' => $email['fromid'] ) ); ?>" class="pull-left avatar-circle" title="<?php echo $email['fromName'] ?>">
						<img src="avatar.php?uid=<?php echo $email['fromid']; ?>&engine=<?php echo ENGINE; ?>" alt="<?php echo $email['fromName'] ?>">
					</a>
					<div class="media-body">
						...
						<p id="mal_info_brief">
							<?php echo $email['fromName']; ?> <?php echo $lang['At']; ?> <?php echo $email['dateTime'] ?> ( <?php echo $lang['Week'] . $weekDay; ?> ) <?php echo $lang['Send to']; ?> <?php echo StringUtil::cutStr( implode( '、', $allUsers ), 45 ); ?> <?php if ( count( $allUsers ) > 1 ): ?><?php echo $lang['Such as']; ?><?php echo count( $allUsers ); ?><?php echo $lang['People']; ?><?php endif; ?>。
						</p>
