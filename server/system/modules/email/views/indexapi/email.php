...
<?php if ( !empty( $emails ) ): ?>
		...
		<tbody>
			<?php foreach ( $emails as $email ): ?>
				<tr>
					...
					<td>
						<a title="<?php echo $email['subject']; ?>" href="<?php echo Yii::app()->urlManager->createUrl( 'email/content/show', array('id' => $email['emailid']) ); ?>" <?php if ( !$email['isread'] ): ?>class="xwb"<?php endif; ?>><?php echo StringUtil::cutStr( $email['subject'], 25 ); ?></a>
					</td>
					<td width="80">
	...
	<div class="mbox-base">
		<div class="fill-hn xac">
			<a href="<?php echo Yii::app()->urlManager->createUrl( 'email/list/index' ); ?>" class="link-more">
