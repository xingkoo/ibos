			...
			<table class="table table-bordered table-hover table-operate" style="width:70%">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitrealname[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitrealname"]["visi"]) echo "checked"; ?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitsex[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitsex"]["visi"]) echo "checked"; ?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitbirthday[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitbirthday"]["visi"]) echo "checked"; ?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitbirthplace[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitbirthplace"]["visi"]) echo "checked"; ?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitworkyears[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitworkyears"]["visi"]) echo "checked"; ?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruiteducation[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruiteducation"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitstatus[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitstatus"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitidcard[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitidcard"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitheight[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitheight"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitweight[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitweight"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitmaritalstatus[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitmaritalstatus"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitresidecity[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitresidecity"]["visi"]) echo "checked"; ?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitzipcode[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitzipcode"]["visi"]) echo "checked"; ?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitmobile[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitmobile"]["visi"]) echo "checked"; ?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="rucruitemail[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["rucruitemail"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruittelephone[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruittelephone"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitqq[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitqq"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitmsn[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitmsn"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitbeginworkday[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitbeginworkday"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruittargetposition[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruittargetposition"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitexpectsalary[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitexpectsalary"]["visi"]) echo "checked"; ?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitworkplace[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitexpectsalary"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitrecchannel[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitrecchannel"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitworkexperience[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitworkexperience"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitprojectexperience[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitprojectexperience"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruiteduexperience[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruiteduexperience"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitlangskill[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitlangskill"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitcomputerskill[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitcomputerskill"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitprofessionskill[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitprofessionskill"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruittrainexperience[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruittrainexperience"]["visi"]) echo "checked";?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitselfevaluation[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitselfevaluation"]["visi"]) echo "checked"; ?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitrelevantcertificates[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitrelevantcertificates"]["visi"]) echo "checked"; ?> >
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="checkbox" name="recruitsocialpractice[visi]" id="" data-toggle="switch" class="visi-hidden" value="1" <?php if ($config["recruitsocialpractice"]["visi"]) echo "checked";?> >
						</td>
						<td>
