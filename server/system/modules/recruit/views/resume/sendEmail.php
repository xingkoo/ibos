		...
		<div class="mcr">
			...
			<form action="<?php echo $this->createUrl("resume/saveInterview");?>" method="post" 
				...
				<div class="ct ctform cti">
					...
					<div class="well well-full">
						<div class="mal-form">
										...
										<div class="btn-group btn-group-inverse">
											<ul class="dropdown-menu"  data-toggle="imitate-select" data-input="#web_mail">
												...
												<?php foreach ($emailWebList as $emailWeb ) : ?>
													<li <?php if ($firstIndex) echo 'class="active"'; ?> data-value="<?php echo $emailWeb["webid"];?>">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="emailbody[subject]" placeholder="<?php echo $lang["Please enter a message subject"];?>" id="mal_title" value="">
								</div>
							</div>
						</div>
						<!-- Row 8 编辑器  -->
					...
					<!-- Row 10 Button -->
					<div id="submit_bar" class="clearfix" data-my-name="inaki">
