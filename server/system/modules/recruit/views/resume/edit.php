...
<div class="wrap">
	<div class="mc clearfix">
		...
		<!-- Mainer right -->
		<div class="mcr">
			<form action="<?php echo $this->createUrl("resume/edit", array("op" => "update"));?>" method="post" class="form-horizontal" id="edit_resume">
				<div class="ct ctform bglb bdbs" id="basic_info">
                    ...
                    <div class="row">
                        ...
                        <div class="span8">
                            <div class="row">
                                <!-- 姓名 -->
                                <div class="span6" data-expand-target="recruitrealname" <?php if (!$dashboardConfig["recruitrealname"]["visi"]) echo 'style="display: none;"';?> >
                                    <div class="control-group">
                                ...
                                <!-- 性别 -->
                                <div class="span6" data-expand-target="recruitsex" <?php if (!$dashboardConfig["recruitsex"]["visi"]) echo 'style="display: none;"';?> >
                                    <label class="control-label"><?php echo $lang["Sex"];?></label>
                                    <div class="controls">
										<label class="radio radio-inline">
											<input id="recruitsex" type="radio" name="gender" value="1" <?php if ($resumeDetail["gender"] == 1) echo "checked";?> >
											<?php echo $lang["Male"];?>
"										</label>
										<label class="radio radio-inline">
											<input id="recruitsex" type="radio" name="gender" value="2" <?php if ($resumeDetail["gender"] == 2) echo "checked";?> >
...
"										</label>
                            ...
                            <div class="row">
                                <!-- 生日 -->
                                <div class="span6" data-expand-target="recruitbirthday" <?php if (!$dashboardConfig["recruitbirthday"]["visi"]) echo 'style="display: none;"';?> >
                                    <div class="control-group">
                                ...
                                <!-- 籍贯 -->
                                <div class="span6" data-expand-target="recruitbirthplace" <?php if (!$dashboardConfig["recruitbirthplace"]["visi"]) echo 'style="display: none;"';?> >
                                    <div class="control-group">
					...
					<div class="row">
						<!-- 工作年限 -->
						<div class="span4" data-expand-target="recruitworkyears" <?php if (!$dashboardConfig["recruitworkyears"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
						...
						<!-- 学历 -->
						<div class="span4" data-expand-target="recruiteducation" <?php if (!$dashboardConfig["recruiteducation"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
						...
						<!-- 简历状态 -->
                        <div class="span4" data-expand-target="recruitstatus" <?php if (!$dashboardConfig["recruitstatus"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
					...
					<div class="row">
						<!-- 身高 -->
                        <div class="span4" data-expand-target="recruitheight" <?php if (!$dashboardConfig["recruitheight"]["visi"]) echo 'style="display: none;"';?> >
                        ...
                        <!-- 体重 -->
                        <div class="span4" data-expand-target="recruitweight" <?php if (!$dashboardConfig["recruitweight"]["visi"]) echo 'style="display: none;"';?> >
                        ...
                        <!-- 身份证 -->
                        <div class="span4" data-expand-target="recruitidcard" <?php if (!$dashboardConfig["recruitidcard"]["visi"]) echo '"style="display: none;"';?> >
                            <div class="control-group">
					...
					<div class="row">
						<!-- 婚姻状态 -->
						<div class="span4" data-expand-target="recruitmaritalstatus" <?php if (!$dashboardConfig["recruitmaritalstatus"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
								<label><?php echo $lang["Marital status"];?></label>
								<div>
									<label class="radio radio-inline">
										<input id="recruitmaritalstatus" type="radio" name="maritalstatus" value="0" <?php if ($resumeDetail["maritalstatus"] == 0) echo "checked";?> >
										<?php echo $lang["Unmarried"];?>
									</label>
									<label class="radio radio-inline">
										<input id="recruitmaritalstatus" type="radio" name="maritalstatus" value="1" <?php if ($resumeDetail["maritalstatus"] == 1) echo "checked";?> >
                    ...
                    <div>
                        <div class="alternate-bar">
                            <a href="javascript:;" class="btn btn-small btn-fix" data-click="expandAll" data-expand-all="basic_info">+</a>
                            <?php if (!$dashboardConfig["recruitrealname"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitrealname"><?php echo $lang["Full name"];?></a<span>></span>/
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitsex"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitsex"><?php echo $lang["Sex"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitbirthday"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitbirthday"><?php echo $lang["Date of birth"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitbirthplace"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitbirthplace"><?php echo $lang["Hometown"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitworkyears"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitworkyears"><?php echo $lang["Work years"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruiteducation"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruiteducation"><?php echo $lang["Record of formal schooling"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitstatus"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitstatus"><?php echo $lang["CV status"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitidcard"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitidcard"><?php echo $lang["Idcard"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitheight"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitheight"><?php echo $lang["Height"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitweight"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitweight"><?php echo $lang["Body weight"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitmaritalstatus"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitmaritalstatus"><?php echo $lang["Marital status"];?></a><span>/</span>
                            <?php endif; ?>
                        </div>
                    </div>
				</div>
				...
				<div class="ct ctform" id="contact_info">
					<!-- Row 6 -->
					<div class="row">
						<div class="span8" data-expand-target="recruitresidecity" <?php if (!$dashboardConfig["recruitresidecity"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
                        ...
                        <!-- 邮编 -->
						<div class="span4" data-expand-target="recruitzipcode" <?php if (!$dashboardConfig["recruitzipcode"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
					...
					<div class="row">
						<!-- 手机 -->
                        <div class="span4" data-expand-target="recruitmobile" <?php if (!$dashboardConfig["recruitmobile"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
						...
						<!-- 邮箱 -->
                        <div class="span4" data-expand-target="rucruitemail" <?php if (!$dashboardConfig["rucruitemail"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
						...
						<!-- 电话 -->
						<div class="span4" data-expand-target="recruittelephone" <?php if (!$dashboardConfig["recruittelephone"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
                    ...
                    <div class="row">
						<!-- QQ -->
                        <div class="span4" data-expand-target="recruitqq" <?php if (!$dashboardConfig["recruitqq"]["visi"]) echo '"style="display: none;"';?> >
							<div class="control-group">
						...
						<!-- MSN -->
						<div class="span4" data-expand-target="recruitmsn" <?php if (!$dashboardConfig["recruitmsn"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
                    ...
                    <div>
                        <div class="alternate-bar">
                            <a href="javascript:;" class="btn btn-small btn-fix" data-click="expandAll" data-expand-all="contact_info">+</a>
                            <?php if (!$dashboardConfig["recruitresidecity"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitresidecity"><?php echo $lang["Residence address"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitzipcode"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitzipcode"><?php echo $lang["Zipcode"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitmobile"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitmobile"><?php echo $lang["Phone"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["rucruitemail"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="rucruitemail"><?php echo $lang["Email"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruittelephone"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruittelephone"><?php echo $lang["Telephone"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitqq"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitqq"><?php echo $lang["QQ"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitmsn"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitmsn"><?php echo $lang["MSN"];?></a><span>/</span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="ct ctform" id="apply_info">
					...
					<div class="row">
						<!-- 到岗时间 -->
						<div class="span4" data-expand-target="recruitbeginworkday" <?php if (!$dashboardConfig["recruitbeginworkday"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
						...
						<!-- 应聘岗位 -->
						<div class="span4" data-expand-target="recruittargetposition" <?php if (!$dashboardConfig["recruittargetposition"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
						...
						<!-- 期望月薪 -->
                        <div class="span4" data-expand-target="recruitexpectsalary" <?php if (!$dashboardConfig["recruitexpectsalary"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
                    ...
                    <div class="row">
						<!-- 工作地点 -->
						<div class="span4" data-expand-target="recruitworkplace" <?php if (!$dashboardConfig["recruitworkplace"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
								<label for=""><?php echo $lang["Workplace"];?></label>
								<input id="recruitworkplace" type="text" name="workplace" value="<?php $resumeDetail["workplace"];?>">
							</div>
						</div>
					</div>
					<!-- Row 12 -->
                    <div>
                        <div class="alternate-bar">
                            <a href="javascript:;" class="btn btn-small btn-fix" data-click="expandAll" data-expand-all="apply_info">+</a>
                            <?php if (!$dashboardConfig["recruitbeginworkday"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitbeginworkday"><?php echo $lang["Work time"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruittargetposition"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruittargetposition"><?php echo $lang["Job candidates"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitexpectsalary"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitexpectsalary"><?php echo $lang["Salary expectations"];?></a><span>/</span>
                            <?php endif; ?>

                            <?php if (!$dashboardConfig["recruitworkplace"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitworkplace"><?php echo $lang["Workplace"];?></a><span>/</span>
                            <?php endif; ?>
                        </div>
                    </div>
				</div>
                ...
                <div class="ct ctform" id="detail_info">
					...
					<div class="row">
						 <!-- 简历来源 -->
						<div class="span4" data-expand-target="recruitrecchannel" <?php if (!$dashboardConfig["recruitrecchannel"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
						 ...
						 <!-- 工作经历 -->
						<div class="span12" data-expand-target="recruitworkexperience" <?php if (!$dashboardConfig["recruitworkexperience"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
								<label for=""><?php echo $lang["Work Experience"];?></label>
						 ...
						 <!-- 项目经验 -->
						<div class="span12" data-expand-target="recruitprojectexperience" <?php if (!$dashboardConfig["recruitprojectexperience"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
						 ...
						 <!-- 教育背景 -->
						<div class="span12" data-expand-target="recruiteduexperience" <?php if (!$dashboardConfig["recruiteduexperience"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
								<label for=""><?php echo $lang["Educational background"];?></label>
						 ...
						 <!-- 语言能力 -->
						<div class="span12" data-expand-target="recruitlangskill" <?php if (!$dashboardConfig["recruitlangskill"]["visi"]) echo 'style="display: none;"';?> >
}
...
">
						 ...
						 <!-- IT技能 -->
						<div class="span12" data-expand-target="recruitcomputerskill" <?php if (!$dashboardConfig["recruitcomputerskill"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
						 ...
						 <!-- 职业技能 -->
						<div class="span12" data-expand-target="recruitprofessionskill" <?php if (!$dashboardConfig["recruitprofessionskill"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
						 ...
						 <!-- 培训经历 -->
						<div class="span12" data-expand-target="recruittrainexperience" <?php if (!$dashboardConfig["recruittrainexperience"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
						 ...
						 <!-- 自我评价 -->
						<div class="span12" data-expand-target="recruitselfevaluation" <?php if (!$dashboardConfig["recruitselfevaluation"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
						 ...
						 <!-- 相关证书 -->
						<div class="span12" data-expand-target="recruitrelevantcertificates" <?php if (!$dashboardConfig["recruitrelevantcertificates"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
						 ...
						 <!-- 社会实践 -->
						<div class="span12" data-expand-target="recruitsocialpractice" <?php if (!$dashboardConfig["recruitsocialpractice"]["visi"]) echo 'style="display: none;"';?> >
							<div class="control-group">
                    ...
                    <div>
                        <div class="alternate-bar">
                            <a href="javascript:;" class="btn btn-small btn-fix" data-click="expandAll" data-expand-all="detail_info">+</a>
                            <?php if (!$dashboardConfig["recruitrecchannel"]["visi"]) : ?>
                  		        <a href="javascript:;" data-click="expandItem" data-expand="recruitrecchannel"><?php echo $lang["Resume source"];?></a><span>/</span>
                            <?php endif;?>

							<?php if (!$dashboardConfig["recruitworkexperience"]["visi"]) : ?>
                        	    <a href="javascript:;" data-click="expandItem" data-expand="recruitworkexperience"><?php echo $lang["Work Experience"];?></a><span>/</span>
                            <?php endif;?>

                            <?php if (!$dashboardConfig["recruitprojectexperience"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitprojectexperience"><?php echo $lang["Project Experience"];?></a><span>/</span>
                            <?php endif;?>

                            <?php if (!$dashboardConfig["recruiteduexperience"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruiteduexperience"><?php echo $lang["Educational background"];?></a><span>/</span>
                            <?php endif;?>

                            <?php if (!$dashboardConfig["recruitlangskill"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitlangskill"><?php echo $lang["Language skills"];?></a><span>/</span>
                            <?php endif;?>

                            <?php if (!$dashboardConfig["recruitcomputerskill"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitcomputerskill"><?php echo $lang["IT skills"];?></a><span>/</span>
                            <?php endif;?>

                            <?php if (!$dashboardConfig["recruitprofessionskill"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitprofessionskill"><?php echo $lang["Vocational skills"];?></a><span>/</span>
                            <?php endif;?>

                            <?php if (!$dashboardConfig["recruittrainexperience"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruittrainexperience"><?php echo $lang["Training experience"];?></a><span>/</span>
                            <?php endif;?>

                            <?php if (!$dashboardConfig["recruitselfevaluation"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitselfevaluation"><?php echo $lang["Self-evaluation"];?></a><span>/</span>
                            <?php endif;?>

                            <?php if (!$dashboardConfig["recruitrelevantcertificates"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitrelevantcertificates"><?php echo $lang["Relevant certificate"];?></a><span>/</span>
                            <?php endif;?>

                            <?php if (!$dashboardConfig["recruitsocialpractice"]["visi"]) : ?>
	                            <a href="javascript:;" data-click="expandItem" data-expand="recruitsocialpractice"><?php echo $lang["Social practice"];?></a><span>/</span>
                            <?php endif;?>
						</div>
                    </div>
                </div>
						...
						<div>
							<div class="attl" id="file_target">
								...
								<div class="attl-item" data-node-type="attachItem">
									...
									<i class="atti">
										<img width="32" height="32" src="<?php echo $fileInfo["iconsmall"];?>" alt="<?php echo $fileInfo["filename"];?>" title="<?php echo $fileInfo["filename"];?>">
									</i>
...
<script>
	(function(){
		...
		//判断各个输入项的验证规则要求
		$.formValidator.initConfig({ formID:"edit_resume", errorFocus:true});
		var regex = '<?php echo $dashboardConfigToJson;?>';
		var regulars = '<?php echo $regulars;?>';
		var regexJson = $.parseJSON(regex);
		var regularsJson = $.parseJSON(regulars);
		for (var verification_field in regexJson ) {
			var isCustomRegex = true;	//初始化规则为自定义的正则表达式
			//如果这项没展开(折叠) 或判断验证规则是不是无要求，则跳过这项的验证
			if ( regexJson[verification_field]['visi'] == '1' &&  regexJson[verification_field]['fieldrule'] != 'notrequirement') {
    			for (var index in regularsJson ) {
    			//判断是否是系统的验证规则还是自己写的正则表达式，break为了只验证一次
    				if ( regularsJson[index]['type'] == regexJson[verification_field]['fieldrule'] ) {
    					$('#' + verification_field ).formValidator()
    					.regexValidator({
    						regExp: regexJson[verification_field]['fieldrule'],
    						dataType: "enum",
    						onError: regularsJson[index]['desc']
    					});
    			...
    			if ( isCustomRegex === true ) {
    				...
    				.regexValidator({
    					...
    					onError: U.lang('REC.PLEASE_ENTER_A_CORRECT_FORMAT')
    				});
    			}
            } 
		};
		...
		// 头像上传
		Ibos.upload.image({
            post_params: {module:'recruit', type:'recruit'},
