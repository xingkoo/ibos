        ...
        <div class="mcr">
            ...
            <div class="ct ctview ct-affix">
                <div class="btn-toolbar noprint" data-spy="affix" data-offset-top="70">
                    ...
                    <div class="btn-group">
                        <a href="javascript:;" class="btn" id="print"><?php echo $lang["Print"];?></a>
                    </div>
                ...
                <div>
                    <div id="resume_detail">
                        ...
                        <div class="bglb bdpt bdbs fill clearfix">
                            <div class="pull-left">
                                <div class="rsm-avt">
									<img <?php if (!empty($resumeDetail["avatarUrl"])) : ?> 
										src="<?php echo $resumeDetail["avatarUrl"];?>"
									<?php elseif ($resumeDetail["gender"] == "女") : ?>
                            ...
                            <div class="rsm-psn-info">
                                <div class="rsm-psn-header">
                                    ...
                                    <a href="javascript:;" class="pull-right fss noprint" data-click="togglePersonalDetail"><?php echo $lang["View complete details"];?><i class="caret caret-small vam mls"></i></a>
                                </div>
                                <div>
                        ...
                        <div class="fill">
        					<div class="alternate-bar noprint">
        						<a href="javascript:;" class="btn" data-click="expandAll" data-expand-all="resume_detail">+</a>
        						<a href="javascript:;" data-click="expandItem" data-expand="recruitlangskill"> <?php echo $lang["Language skills"];?></a>
                                <span>/</span>
        						<a href="javascript:;" data-click="expandItem" data-expand="recruitcomputerskill"> <?php echo $lang["IT skills"];?></a>
                                <span>/</span>
        						<a href="javascript:;" data-click="expandItem" data-expand="recruitprofessionskill"> <?php echo $lang["Vocational skills"];?></a>
                                <span>/</span>
        						<a href="javascript:;" data-click="expandItem" data-expand="recruittrainexperience"> <?php echo $lang["Training experience"];?></a>
                                <span>/</span>
        						<a href="javascript:;" data-click="expandItem" data-expand="recruitselfevaluation"> <?php echo $lang["Self-evaluation"];?></a>
                                <span>/</span>
        						<a href="javascript:;" data-click="expandItem" data-expand="recruitrelevantcertificates"> <?php echo $lang["Relevant certificate"];?></a>
                                <span>/</span>
        						<a href="javascript:;" data-click="expandItem" data-expand="recruitsocialpractice"> <?php echo $lang["Social practice"];?></a>
							</div>
                    ...
                    <div class="mb noprint">
                        <div>
                            <ul class="nav nav-tabs nav-tabs-large nav-justified" id="record">
                                <!-- <input type="hidden" name="contentType" id="content_type_value" value="1" /> -->
                                <li class="active">
                                    <a href="javascript:;" data-target="#contact_record" data-value="1">
                                        <i class="o-art-text"></i>
                                        <?php echo $lang["Contact record"];?>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:;" data-target="#interview_record" data-value="3">
                                        <i class="o-art-picm"></i>
                                        <?php echo $lang["Interview record"];?>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:;" data-target="#backdrop_record" data-value="2">
                                ...
                                <div id="contact_record">
                                    <div class="page-list">
                                        <div class="page-list-header">
                                            <button class="btn btn-primary" data-click="addContact"><?php echo $lang["Add"];?></button>
                                            <button class="btn" data-click="deleteContacts"><?php echo $lang["Delete"];?></button>
                                            <button class="btn" data-click="exportContact"><?php echo $lang["Export"];?></button>
                                        </div>
                                                ...
                                                <tbody id="contact_tbody">
                                                    <?php foreach ($contactList as $contact ) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="javascript:" data-click="editContact" data-id="<?php echo $contact["contactid"];?>" title="<?php echo $lang["Update"];?>" class="cbtn o-edit"></a>
                                                                <a href="javascript:" data-click="deleteContact" data-id="<?php echo $contact["contactid"];?>"  title="<?php echo $lang["Delete"];?>" class="cbtn o-trash"></a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                               </tbody>
                                            </table>
											<div class="no-data-tip" <?php if (0 < count($contactList)) echo ' style="display:none" ';?> id="no_contact_tip"></div>
                                        </div>
                                    </div>

                                </div>
                                <!-- 面试记录 -->
                                <div id="interview_record" class="ct" style="display: none;">
                                    <div class="page-list">
                                        <div class="page-list-header">
                                            <button class="btn btn-primary" data-click="addInterview"><?php echo $lang["Add"];?></button>
                                            <button class="btn" data-click="deleteInterviews"><?php echo $lang["Delete"];?></button>
                                            <button class="btn" data-click="exportInterview"><?php echo $lang["Export"];?></button>
                                        </div>
                                        <div class="page-list-mainer">
                                                ...
                                                <tbody id="interview_tbody">
                                                    <?php foreach ($interviewList as $interview ) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="javascript:" data-click="editInterview" data-id="<?php echo $interview["interviewid"];?>" title="<?php echo $lang["Update"];?>" class="cbtn o-edit"></a>
                                                                <a href="javascript:" data-click="deleteInterview" data-id="<?php echo $interview["interviewid"];?>"  title="<?php echo $lang["Delete"];?>" class="cbtn o-trash"></a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
											<div class="no-data-tip" <?php if (0 < count($interviewList)) echo ' style="display:none" ';?> id="no_interview_tip"></div>
                                        </div>
                                    </div>
                                </div>

                                <!-- 背景调查 -->
                                <div id="backdrop_record" style="display: none;">
                                    <div class="page-list">
                                        <div class="page-list-header">
                                            <button class="btn btn-primary" data-click="addBgcheck"><?php echo $lang["Add"];?></button>
                                            <button class="btn" data-click="deleteBgchecks"><?php echo $lang["Delete"];?></button>
                                            <button class="btn" data-click="exportBgcheck"><?php echo $lang["Export"];?></button>
                                        </div>
                                        <div class="page-list-mainer">
                                                ...
                                                <tbody id="bgchecks_tbody">
                                                    <?php foreach ($bgcheckList as $bgcheck ) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="javascript:" data-click="editBgcheck" data-id="<?php echo $bgcheck["checkid"];?>" title="<?php echo $lang["Update"];?>" class="cbtn o-edit"></a>
                                                                <a href="javascript:" data-click="deleteBgcheck" data-id="<?php echo $bgcheck["checkid"];?>"  title="<?php echo $lang["Delete"];?>" class="cbtn o-trash"></a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
											<div class="no-data-tip" <?php if (0 < count($bgcheckList)) echo ' style="display:none" ';?> id="no_bgchecks_tip"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<tr>
    ...
    <td>
        ...
        <a href="javascript:" data-click="deleteContact" data-id="<%=contactid%>"  title="<?php echo $lang["Delete"];?>" class="cbtn o-trash"></a>
    </td>
</tr>
</script>
<!-- 插入面试信息模板 -->
...
<tr>
    ...
    <td>
        ...
        <a href="javascript:" data-click="deleteInterview" data-id="<%=interviewid%>"  title="<?php echo $lang["Delete"];?>" class="cbtn o-trash"></a>
    </td>
</tr>
</script>
<!-- 插入背景信息模板 -->
...
<tr>
    ...
    <td>
        ...
        <a href="javascript:" data-click="deleteBgcheck" data-id="<%=checkid%>"  title="<?php echo $lang["Delete"];?>" class="cbtn o-trash"></a>
    </td>
</tr>
</script>
<script>
