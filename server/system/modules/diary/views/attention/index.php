			...
			<div class="page-list">
				<div class="page-list-header">
					...
					<div class="btn-group pull-left mls">
						<a href="<?php echo $this->createUrl( 'attention/index', array( 'date' => 'yesterday' ) ) ?>" class="btn <?php $date = EnvUtil::getRequest( 'date' );
							if ( $date == 'yesterday' || !isset( $date ) ): ?>active<?php endif; ?>"><?php echo $lang['Yesterday']; ?></a>
                        <a href="<?php echo $this->createUrl( 'attention/index', array( 'date' => 'today' ) ) ?>" class="btn <?php $date = EnvUtil::getRequest( 'date' );
...
<script>
	$(function() {
		...
		$('#da_date_btn').datepicker().on("changeDate", function(evt) {
			...
			location.href = Ibos.app.url("diary/attention/index", { date: date})
		});
	})
</script>
