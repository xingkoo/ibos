...
<div class="mc clearfix">
	<!-- Sidebar -->
	<?php echo $this->widget( 'IWDiaryReviewSidebar', array(), true ); ?>
	<!-- Mainer right -->
	<div class="mcr">
		<div class="page-list">
			<div class="page-list-header">
				...
				<div class="btn-group pull-left mls">
					<a href="<?php echo $this->createUrl( 'review/index', array( 'date' => 'yesterday' ) ) ?>" class="btn 
						<?php $curDate = EnvUtil::getRequest( 'date' ); if ( $curDate == 'yesterday' || !isset( $curDate ) ): ?>active<?php endif; ?>"><?php echo $lang['Yesterday']; ?></a>
					<a href="<?php echo $this->createUrl( 'review/index', array( 'date' => 'today' ) ) ?>" class="btn 
						<?php if ( EnvUtil::getRequest( 'date' ) == 'today' ): ?>active<?php endif; ?>"><?php echo $lang['Today']; ?></a>
			...
			<div class="page-list-mainer">
				<ul class="da-list" id="da_list">
					<?php if ( count( $data ) > 0 ): ?>
					<?php $stampPath = FileUtil::fileName( Stamp::STAMP_PATH);?>
								...
								<div class="da-summary">
									<div class="avatar-box">
										<a href="<?php echo $this->createUrl( 'review/personal', array( 'uid' => $diary['uid'] ) ) ?>" class="avatar-circle">
											<img class="mbm" src="avatar.php?uid=<?php echo $diary['uid']; ?>&size=middle&engine=<?php echo ENGINE; ?>" alt="">
										</a>
				...
				<?php endif; ?>
					...
					<div class="da-remind">
						...
						<ul class="da-remind-list">
							...
							<li data-uid="<?php echo $user['uid']; ?>">
								<a href="<?php echo $this->createUrl( 'review/personal', array( 'uid' => $user['uid'] ) ); ?>" target="_blank" class="avatar-box">
									<span class="avatar-circle">
										<img class="mbm" src="avatar.php?uid=<?php echo $user['uid']; ?>&size=middle&engine=<?php echo ENGINE; ?>" alt="">
									</span>
							...
							<?php endforeach; ?>
							<li class="da-bell">
								<?php if(MainUtil::getCookie('reminded_' . strtotime($date))): ?>
