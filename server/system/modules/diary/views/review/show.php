			...
			<div class="page-list-mainer posr">
				...
				<table class="da-detail-table">
					...
					<div class="da-stamp" style="position: absolute; top: 25px; right: 180px; z-index: 1000">
						<span id="preview_stamp">
							<?php if ( $diary['stamp'] > 0 ): ?><img id="stamp_<?php echo $diary['diaryid']; ?>" src="<?php echo FileUtil::fileName( Stamp::STAMP_PATH . $stampUrl ); ?>" width="150px" height="90px" /><?php endif; ?>
						</span>
					</div>
					<!-- 原计划 -->
				...
				<div class="cti bdbs">
					...
					<div id="comment" class="comment">
						<?php
							$this->widget( 'IWDiaryComment', array(
								'module' => 'diary',
								'table' => 'diary',
								'attributes' => array(
									'rowid' => $diary['diaryid'],
...
<script>
	(function() {
		...
		$stampBtn.on("stampChange", function(evt, data) {
			var stamp = '<img src="<?php echo FileUtil::fileName( Stamp::STAMP_PATH ); ?>' + data.stamp + '" width="150px" height="90px" />',
