                ...
                <div class="aside-sub">
                    <ul class="da-share-user-list">
                        ...
                        <li>
                            ...
                            <a href="<?php echo $this->createUrl('share/index', array( 'op' => 'personal', 'uid'=>$diary['uid']) ); ?>" <?php if(EnvUtil::getRequest( 'uid') == $diary['uid']): ?>style="color:#3497DB;"<?php endif; ?>><?php echo $diary['user']['realname']; ?></a>
