...
<link rel="stylesheet" href="<?php echo Ibos::app()->assetManager->getAssetsUrl( 'diary' ); ?>/css/dbdiary.css?<?php echo VERHASH; ?>">
<div class="ct">
	<div class="clearfix">
...
<script src="<?php echo Ibos::app()->assetManager->getAssetsUrl( 'diary' ); ?>/js/dbdiary.js?<?php echo VERHASH; ?>"></script>
<script>
