		...
		<div class="bdbs fill" style="height:45px;">
            <?php if ( !empty($diary) ): ?>
                ...
                <?php if( isset( $stampUrl ) ): ?>
                    <img src="<?php echo FileUtil::fileName( Stamp::STAMP_PATH . $stampUrl);?>" alt="" width="135" height="81" class="in-diary-stamp">
                <?php else: ?>
                    <div class="mb xac">
            ...
            <?php else: ?>
                <div class="xac">
                    <a href="<?php echo Yii::app()->urlManager->createUrl('diary/default/add'); ?>" class="btn btn-warning">
                        <i class="o-new"></i>
...
<?php else: ?>
    <div class="in-diary-left">
        ...
        <div class="show">
            <table class="table table-underline">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo Yii::app()->urlManager->createUrl('diary/review/show',array('diaryid'=>$review['diaryid'])); ?>"><?php echo $review['user']['realname'].' &nbsp; '.$review['diarytime']; ?></a>
                        </td>
                        <td width="60">
                    ...
                    <tr>
                        ...
                        <td width="60">
                            ...
                            <img src="<?php echo FileUtil::fileName( Stamp::STAMP_PATH) . $iconUrl  ?>" alt="">
							<?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
            ...
            <div class="mbox-base">
                <div class="fill-hn xac">
                    <a href="<?php echo Yii::app()->urlManager->createUrl('diary/review/index'); ?>" class="link-more"> <i class="cbtn o-more"></i>
        ...
        <div class="in-diary-appraise-empty 
			<?php if( MainUtil::getCookie( 'reminded_' . strtotime( date('Y-m-d' ) ) ) ): ?>o-da-reminded<?php endif; ?>">
			<?php if( !MainUtil::getCookie( 'reminded_' . strtotime( date('Y-m-d' ) ) ) ): ?>
        ...
        <div class="fill-hh">
            ...
            <div>
                ...
                <ul class="list-inline">
    				...
    				<li>
                        <a href="<?php echo Yii::app()->urlManager->createUrl('diary/review/index'); ?>">
