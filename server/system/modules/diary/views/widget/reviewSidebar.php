    ...
    <div class="sbb sbbl sbbf">
        <ul class="nav nav-strip nav-stacked">
            ...
            <li <?php if ( $id == 'review' ): ?>class="active"<?php endif; ?>>
				...
				<?php echo $this->getController()->widget( 'IWDiarySublist', array( 'stats' => false ), true ); ?>
            </li>
			...
			<?php if ( ModuleUtil::getIsEnabled( 'statistics' ) && isset( $statModule['diary'] ) ): ?>
				<?php echo $this->widget( StatCommonUtil::getWidgetName( 'diary', StatConst::SIDEBAR_WIDGET ), array( 'hasSub' => $hasSub, 'fromController' => 'review' ), true ); ?>
			<?php endif; ?>
        </ul>
    </div>
</div>