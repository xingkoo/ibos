	...
	<div>
		...
		<div class="ctb ctbp">
			...
			<?php if ( !defined( 'LICENCE_VER' ) ): ?>
				<div class="license">
					<?php if ( defined( 'LICENCE_ERR' ) ):echo LICENCE_ERR;
					else:
						?>该系统还没授权<?php endif; ?>，您可以
					<a href="javascript:;" class="b-anchor" data-click="inputAuthCode">输入授权码</a>
					或
					<a href="<?php echo $licenseUrl; ?>" class="o-anchor" target="_blank">立即申请授权码</a>
				</div>
<?php else: ?>
				<div class="license licensed" data-click="showAuthInfo">
					<span>授权企业：</span>
					<!-- 公司全称 -->
					<strong title="<?php echo LICENCE_FULLNAME; ?>"><?php echo StringUtil::cutStr( LICENCE_FULLNAME, 30 ); ?></strong>
					&nbsp;
