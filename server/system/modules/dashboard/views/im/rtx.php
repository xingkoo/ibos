	...
	<div id="cm_content">
		<div>
			<form action="<?php echo $this->createUrl( 'im/index' ); ?>" method='post' class="form-horizontal">
						...
						<div class="control-group">
							...
							<div class="controls row">
								...
								<div class="span8">
									...
									<a target="_blank" href="http://www.ibos.com.cn/html/help//foradmin/2013/0617/54.html"><?php echo $lang['Click to view helper doc']; ?></a>
								</div>
							</div>
						</div>
				...
				<!-- 同步组织架构 start -->
				<div class="ctb" id="sync" <?php if ( $im['open'] == '0' ): ?>style="display: none;"<?php endif; ?>>
					<h2 class="st"><?php echo $lang['Synchronize org']; ?></h2>
					<div class="alert trick-tip">
						<div class="trick-tip-title">
							<i></i>
							<strong><?php echo $lang['Skills prompt']; ?></strong>
						...
						<div class="control-group">
							...
							<div class="controls">
								<div class="row">
									...
									<div class="span5">
										<a href="javascript:void(0);" data-act='syncorg' class="btn"><?php echo $lang['Synchronization Immediate']; ?></a>
									</div>
								</div>
							</div>
						</div>
...
<script>
	(function() {
		$("#rtx_enable").on("change", function() {
			$("#rtx_setup, #sync").toggle();
		});
		$("[data-act='syncorg']").on('click', function() {
			if ($('#rtx_init_pwd').val() == '') {
				$('#rtx_init_pwd').blink();
				return false;
			}
			Ui.confirm(U.lang("DB.RTX_SYNC_CONFIRM"), function() {
				...
				var url = Ibos.app.url('dashboard/im/syncorg', {type: 'rtx', pwd: pwd});
				Ui.dialog({
