    ...
    <div>
        <form action="" class="form-horizontal">
                                        ...
                                        <?php foreach ( $actions as $key => $value ) : ?>
                                            ...
                                            <optgroup label="<?php echo $label; ?>">
                                                <?php foreach ( $value as $action => $desc ) : ?>
                                                    <option <?php if ( $filterAct == $action ): ?>selected<?php endif; ?> value="<?php echo $action; ?>"><?php echo $desc; ?></option>
                                                <?php endforeach; ?>
                                            </optgroup>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <?php switch ( $level ) :case 'admincp': ?>
                                        <?php foreach ( $log as $key => $value ) : ?>
                                            ...
                                            if ( isset( $operationInfo[1] ) ) {
                                                ...
                                                $actionDesc = @$actions[$route[1]][$route[2]];
                                            }
                                            ?>
                                            <tr>
                                                <td>
            <?php echo $row['user']; ?>
                                                ...
                                                <td><span title="<?php echo $row['param']; ?>"><?php echo StringUtil::cutStr( $row['param'], 100 ); ?></span></td>
                                            </tr>
                                        <?php endforeach; ?>
                                        <?php
                                        break;
