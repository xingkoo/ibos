...
<html lang="en">
	...
	<body>
			...
			<div class="hdbar clearfix" id="bar">
				...
				<div class="user-info pull-right">
					<span class="user-name">
						<a href="<?php echo Ibos::app()->user->space_url; ?>" target="_blank"><img width="30" height="30" class="radius msep" src="avatar.php?uid=<?php echo Ibos::app()->user->uid; ?>&size=small&engine=<?php echo ENGINE; ?>" title="<?php echo Ibos::app()->user->realname; ?>"></a>
		...
		<div class="mainer" id="mainer">
			...
			<div class="mc" id="mc">
				<iframe src="<?php echo $index['index']; ?>" width="100%" height="100%" frameborder="0" name="main" id="main"></iframe>
			</div>
		</div>
