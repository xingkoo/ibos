							...
							<div id="watermark_type_text" <?php if ( $waterMark['watermarktype'] !== 'text' ): ?>style="display: none;"<?php endif; ?>>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<div class="input-group">
											<button type="button" href="javascript:;" id="watermark_color_ctrl" class="btn btn-fix" style="background-color: rgb(<?php echo implode( ',', ConvertUtil::hexColorToRGB( $waterMark['watermarktext']['color'] ) ); ?>)"></button>
										</div>
									</div>
								</div>
							</div>
