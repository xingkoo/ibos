							...
							<?php foreach ( $list as $key => $stamp ): ?>
								<li>
									...
									<div class="stamp-img">
										...
										<img <?php if ( !empty( $stamp['stamp'] ) ): ?>src="<?php echo FileUtil::fileName( $stampUrl . $stamp['stamp'] ); ?>"<?php endif; ?> alt="<?php echo $stamp['code']; ?>" />
									...
									<div class="stamp-icon">
										...
										<img <?php if ( !empty( $stamp['icon'] ) ): ?>src="<?php echo FileUtil::fileName( $stampUrl . $stamp['icon'] ); ?>"<?php endif; ?> alt="<?php echo $stamp['code']; ?>" />
