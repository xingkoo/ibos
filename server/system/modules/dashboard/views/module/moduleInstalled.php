								...
								<tr>
									<td>
										...
										<?php if ( $config['param']['icon'] ): ?>
											<img src="<?php echo Yii::app()->assetManager->getAssetsUrl( $module['module'] ) . '/image/icon.png'; ?>">
										<?php else: ?>
									...
									<td>
										...
										<?php else: ?>
											<input type="checkbox" <?php if ( $module['disabled'] == 0 && ModuleUtil::getIsEnabled( $module['module'] ) ): ?>checked<?php endif; ?> value="<?php echo $module['module']; ?>" data-toggle="switch" class="visi-hidden">
										<?php endif; ?>
									</td>
									<td>
