...
INSERT INTO `{{nav}}` (`id`, `pid`, `name`, `url`, `targetnew`, `system`, `disabled`, `sort`, `module`, `type`, `pageid`) VALUES ('4', '0', '日志总结', 'javascript:void(0);', '0', '1', '0', '4','','0', '0');
INSERT INTO `{{nav}}` (`id`, `pid`, `name`, `url`, `targetnew`, `system`, `disabled`, `sort`, `module`, `type`, `pageid`) VALUES ('8', '0', '人力资源', 'javascript:void(0)', '0', '1', '0', '8','','0', '0');

INSERT INTO `{{nav}}` (`id`, `pid`, `name`, `url`, `targetnew`, `system`, `disabled`, `sort`, `module`, `type`, `pageid`) VALUES ('9', '1', '个人门户', 'weibo/home/index', '0', '1', '0', '2','','0', '0');
INSERT INTO `{{nav}}` (`id`, `pid`, `name`, `url`, `targetnew`, `system`, `disabled`, `sort`, `module`, `type`, `pageid`) VALUES ('10', '1', '办公门户', 'main/default/index', '0', '1', '0', '1','','0', '0');

INSERT INTO `{{nav}}` (`id`, `pid`, `name`, `url`, `targetnew`, `system`, `disabled`, `sort`, `module`, `type`, `pageid`) VALUES ('11', '8', '组织架构', 'organization/department/index', '0', '1', '0', '1','organization','0', '0');
...
INSERT INTO `{{approval}}` (`name`, `level`, `level1`, `level2`, `level3`, `level4`, `level5`, `free`, `desc`, `addtime`) VALUES ('新闻审核', '1', '1', '', '', '', '', '', '', '1402631014');
INSERT INTO `{{approval}}` (`name`, `level`, `level1`, `level2`, `level3`, `level4`, `level5`, `free`, `desc`, `addtime`) VALUES ('公文审核', '2', '1', '1', '', '', '', '', '', '1402631014');