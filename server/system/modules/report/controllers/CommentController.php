...
class ReportCommentController extends ICController
{
    public function actionGetCommentList()
    {
        if (EnvUtil::submitCheck("formhash")) {
            ...
            $widget = Ibos::app()->getWidgetFactory()->createWidget($this, "IWReportComment", $properties);
    ...
    {
        if (EnvUtil::submitCheck("formhash")) {
            $widget = Ibos::app()->getWidgetFactory()->createWidget($this, "IWReportComment");
