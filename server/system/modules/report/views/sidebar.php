					...
					<?php else : ?>
						<tr>
							...
							<td data-name="intervaltype" data-value="<?php echo $reportType["intervaltype"];?>">
								...
								<?php if ($reportType["intervaltype"] == 5) : ?>
									<?php echo $reportType["intervals"] . $lang["Day"];?>
								<?php else : ?>
									<?php echo ICReportType::handleShowInterval($reportType["intervaltype"]);?>
								<?php endif; ?>
							</td>
							<td>
								<a href="javascript:;" data-click="editType" class="anchor" data-id="<?php echo $reportType["typeid"];?>"><?php echo $lang["Edit"];?></a>
								<a href="javascript:;" data-click="delType" class="anchor mlm" data-id="<?php echo $reportType["typeid"];?>"><?php echo $lang["Delete"];?></a>
							</td>
						</tr>
					<?php endif; ?>
				<?php endforeach; ?>
...
<script type="text/template" id="rp_type_tpl">
	<tr>
		...
		<td>
			...
			<a href="javascript:;" data-click="delType" class="anchor mlm" data-id="<%=typeid%>"><?php echo $lang["Delete"];?></a>
		</td>
	</tr>
</script>
...
<script type="text/template" id="rp_type_edit_tpl">
	<tr>
		...
		<td class="clear-fix">
			<select value="<%=intervaltype%>" name="intervaltype" class="input-small span5" style="float:left">
				<option value="0"><?php echo $lang["Week"];?></option>
				<option value="1"><?php echo $lang["Month"];?></option>
				<option value="2"><?php echo $lang["Season"];?></option>
				<option value="3"><?php echo $lang["Half of a year"];?></option>
