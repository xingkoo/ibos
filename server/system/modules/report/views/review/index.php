				...
				<div class="page-list-header">
					<form action="<?php echo $this->createUrl("review/index", array("param" => "search", "user" => $getUser));?>" method="post">
						<div class="search search-config pull-right span3">
							<input type="text" name="keyword" placeholder="Search" id="mn_search" nofocus value="<?php if (EnvUtil::getRequest("param") == "search") echo MainUtil::getCookie("keyword");?>">
