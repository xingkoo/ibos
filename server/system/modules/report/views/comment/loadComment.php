		...
		<div class="cmt-item" id="newCommentBox" data-node-type="commentBox">
			...
			<div class="cmt-body">
				...
				<div class="mbs fss clearfix">
					...
					<?php endif; ?>
					<button type="button" data-act="addcomment" data-param='{"type":"comment","rowid":<?php echo $rowid;?>,"table":"<?php echo $module_table;?>","module":"<?php echo $module;?>","moduleuid":"<?php echo $moduleuid;?>","touid":"<?php echo $touid;?>"}' class="btn btn-primary pull-right" data-loading-text="<?php echo $lang["Posting"];?>"><?php echo $lang["Post comment"];?></button>
				</div>
			</div>
		</div>
	<?php endif; ?>
