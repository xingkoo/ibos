	...
	<?php if (!empty($reports)) : ?>
						...
						<td width="80">
							<div>
								<a title="<?php echo $report["subject"];?>" 
								   href="<?php echo Yii::app()->urlManager->createUrl("report/default/show", array("repid" => $report["repid"]));?>" ><?php echo StringUtil::cutStr($report["subject"], 40);?></a>
							</div>
						</td>
						<td width="20" style="text-align:right;">
							<?php if (!empty($report["iconUrl"])) : ?>
								<img src="<?php echo $report["iconUrl"];?>" alt="">";
							<?php endif; ?>
						</td>
					</tr>
				<?php endforeach; ?>
		...
		<div class="mbox-base">
			<div class="fill-hn xac">
				<a href="<?php echo Yii::app()->urlManager->createUrl("report/default/index");?>" class="link-more">
						...
						<td align="left">
							<div>
								<a title="<?php echo $subReport["subject"];?>" 
								   href="<?php echo Yii::app()->urlManager->createUrl("report/review/show", array("repid" => $subReport["repid"]));?>" 
								><?php echo $subReport["userInfo"]["realname"] . " &nbsp; " . StringUtil::cutStr($subReport["subject"], 40);?></a>
							</div>
						</td>
						<td width="60" style="text-align:right;">
							<?php if (!empty($subReport["iconUrl"])) : ?>
								<img src="<?php echo $subReport["iconUrl"];?>" alt="">
							<?php endif; ?>
