...
<script src='<?php echo $statAssetUrl;?>/js/echarts-plain-map.js?<?php echo VERHASH;?>'></script>
		...
		xAxis: [
			{
				...
				axisTick: {show: false},
				data: [
				<?php foreach ($score->getXaxis() as $date ) : ?>
				'<?php echo $date;?>',
				<?php endforeach; ?>
				],
				axisLine: {show: true,
