...
class AssignmentCommentController extends ICController
{
    public function actionGetCommentList()
    {
        if (EnvUtil::submitCheck("formhash")) {
            ...
            $widget = Ibos::app()->getWidgetFactory()->createWidget($this, "IWAssignmentComment", $properties);
    ...
    {
        if (EnvUtil::submitCheck("formhash")) {
            $widget = Ibos::app()->getWidgetFactory()->createWidget($this, "IWAssignmentComment");
