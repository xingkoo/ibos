			...
			<div class="page-list-header">
				...
				<form action="<?php echo $this->createUrl("finished/index", array("param" => "search"));?>" method="post" class="am-search-bar">
					<div class="datepicker pull-left" >
						<input type="text" class="datepicker-input" name="daterange" id="am_daterange_input" value="<?php if (EnvUtil::getRequest("param") == "search") : ?><?php echo MainUtil::getCookie("daterange");?><?php endif; ?>">
						<a href="javascript:;" class="datepicker-btn" id="am_daterange_btn"></a>
					</div>

					<div class="search pull-right">
						<input type="text" placeholder="<?php echo $lang["Enter the user or task name"];?>" name="keyword" id="mn_search" nofocus value="<?php if (EnvUtil::getRequest("param") == "search") : ?><?php echo MainUtil::getCookie("keyword");?><?php endif; ?>">
						...
						<div class="fill-sn">
							<div class="mini-date">
								...
								<div class="mini-date-body">
									<p><?php echo $lang["Weekday"];?><?php echo DateTimeUtil::getWeekDay($finishDate);?></p>
...
<script src="<?php echo $assetUrl;?>/js/am_finished_list.js?<?php echo VERHASH;?>"></script>