	...
	<?php foreach ($comments as $comment ) : ?>
		<div class="cmt-item" id="comment_<?php echo $comment["cid"];?>">
			...
			<div class="cmt-body">
				...
				<div class="mbs fss">
					<span><?php echo ConvertUtil::formatDate($comment["ctime"], "u");?></span>
					<div class="pull-right">
						<a href="javascript:;" data-act="getreply" data-param='{"type":"reply","module":"message","table":"comment","rowid":"<?php echo $comment["cid"];?>","name":"<?php echo $comment["user_info"]["realname"];?>","type":"reply"}'>
							<?php echo $lang["Reply"];?>(<?php echo $comment["replys"];?>)
						</a>
						<?php if ($comment["isCommentDel"]) : ?>
							<a class='mls' href="javascript:;" data-act="delcomment" data-param='{"cid":"<?php echo $comment["cid"];?>"}'><?php echo $lang["Delete"];?></a>
						<?php endif; ?>
					</div>
				</div>
	...
	<?php if (!$loadmore) : ?>
		<?php if (10 < $count) : ?>
			<div id="commentMoreFoot" style="padding: 10px;" data-node-type="moreCommentWrap">
				<button type="button" style="width: 100%;" class="btn" id="load_more_btn" data-act="loadmorecomment" data-node-type="moreComment" data-param='{"type":"comment","rowid":<?php echo $rowid;?>,"table":"<?php echo $module_table;?>","module":"<?php echo $module;?>","moduleuid":"<?php echo $moduleuid;?>"}'><?php echo $lang["See more"];?></button>
			</div>
		<?php endif; ?>
		<!-- 新增评论 -->
			...
			<div class="cmt-body" style="margin-left: 0">
				...
				<div class="mbs fss clearfix">
					...
					<button type="button" data-act="addcomment" data-param='{
						...
						"touid":"<?php echo $touid;?>"}' class="btn btn-primary pull-right" data-loading-text="<?php echo $lang["Posting"];?>"><?php echo $lang["Post comment"];?></button>
				</div>
			</div>
