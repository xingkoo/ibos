	...
	<div class="am-details-hd">
		...
		<div class="am-details-hd-ct">
			...
			<div class="am-details-prop clearfix">
				...
				<?php if ($assignment["endtime"] < TIMESTAMP) : ?>
					<span class="ilsep fss"><i class="om-am-warning-w"></i> <?php echo $lang["Expired"];?></span>
				<?php endif; ?>

				<?php if (0 < $assignment["remindtime"]) : ?>
					<span class="ilsep fss"><i class="om-am-clock-w"></i> <?php echo $lang["Has been set to remind"];?></span>
				<?php endif; ?>
	...
	<div class="am-details-bd clearfix">
		<?php if (isset($assignment["stampUrl"])) : ?>
			<div id="am_stamp_holder">
				<!-- 输出已选中的图章  -->
				<img src="<?php echo FileUtil::fileName(Stamp::STAMP_PATH . $assignment["stampUrl"]);?>" width="150" height="90"> 
			</div>
		<?php endif; ?>
		...
		<div class="am-details-rside">
			<div class="fill">
				...
				<div>
					<?php
					$this->widget("IWAssignmentComment", array(
						"module"     => "assignment",
						"table"      => "assignment",
						"attributes" => array("rowid" => $assignment["assignmentid"], "moduleuid" => Ibos::app()->user->uid, "touid" => $assignment["designeeuid"], "module_rowid" => $assignment["assignmentid"], "module_table" => "assignment", "allowComment" => 1, "showStamp" => 1)
						));
					?>
				</div>
			</div>
...
<script>
	Ibos.app.s({
			...
			stampUrl: "<?php echo FileUtil::fileName(stamp::STAMP_PATH);?>",
			// 延期任务、取消任务申请
...
<script src="<?php echo $assetUrl;?>/js/am_default_show.js?<?php echo VERHASH;?>"></script> 