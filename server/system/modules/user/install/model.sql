...
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('1', '初学弟子', '1', '81', '0');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('2', '中级弟子', '1', '401', '81');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('3', '高级弟子', '1', '801', '401');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('4', '初入江湖', '1', '2001', '801');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('5', '小有名气', '1', '4001', '2001');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('6', '名动一方', '1', '7001', '4001');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('7', '江湖豪侠', '1', '18001', '14001');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('8', '一派掌门', '1', '45001', '32001');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('9', '武林盟主', '1', '60001', '45001');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('10', '笑傲江湖', '1', '700001', '400001');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('11', '一代宗师', '1', '100001', '60001');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('12', '超凡入圣', '1', '150001', '100001');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('13', '天人合一', '1', '250001', '150001');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('14', '返璞归真', '1', '400001', '250001');
-- INSERT INTO `{{user_group}}` (`grade`, `title`, `system`, `creditshigher`, `creditslower`) VALUES ('15', '天外飞仙', '1', '999999999', '1000000');
