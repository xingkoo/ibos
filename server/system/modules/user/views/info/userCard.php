...
<div class="uic-banner rdt">
	...
	<div class="uic-operate">
		<?php if (ModuleUtil::getIsEnabled("email")) : ?>
			<a target="_blank" href="<?php echo Ibos::app()->createUrl("email/content/add", array("toid" => $user["uid"]));?>" title="<?php echo $lang["Send email"];?>" class="co-temail"></a>
		<?php endif; ?>

		<?php if (Ibos::app()->user->uid !== $user["uid"]) : ?>
			<a title="<?php echo $lang["Send message"];?>" href="javascript:Ui.showPmDialog(['<?php echo StringUtil::wrapId($user["uid"], "u");?>'],{url:'<?php echo Ibos::app()->createUrl("message/pm/post");?>'});" class="co-tpm">
