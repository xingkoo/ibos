<div class="dib right-sidebar">
	...
	<div class="sidebar-body">
		...
		<div class="progress mb">
			<div class="progress-bar <?php if (90 < $user["upgrade_percent"]) : ?>progress-bar-danger<?php else : ?>progress-bar-success<?php endif; ?>" role="progressbar" aria-valuenow="<?php echo $user["upgrade_percent"];?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $user["upgrade_percent"];?>%;"></div>
		</div>
		<div>
			<div class="dib">
