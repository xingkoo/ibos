			...
			<div class="fill-nn">
				<ul class="pc-skin-list" id="skin_list">
					<li class="active" data-id="1">
						<img data-src="../static/image/temp/bn1.jpg" width="294" height="165">
					...
					<li data-id="2">
						<img data-src="../static/image/temp/bn2.jpg" width="294" height="165">
						<div class="pc-skin-name-wrap">
					...
					<li data-id="3">
						<img data-src="../static/image/temp/bn3.jpg" width="294" height="165">
						<div class="pc-skin-name-wrap">
					...
					<li data-id="4">
						<img data-src="../static/image/temp/bn4.jpg" width="294" height="165">
						<div class="pc-skin-name-wrap">
					...
					<li data-id="5">
						<img data-src="../static/image/temp/bn5.jpg" width="294" height="165">
						<div class="pc-skin-name-wrap">
					...
					<li data-id="6">
						<img data-src="../static/image/temp/bn7.jpg" width="294" height="165">
						<div class="pc-skin-name-wrap">
