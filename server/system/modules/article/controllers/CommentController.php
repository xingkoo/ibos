...
class ArticleCommentController extends ICController
{
    public function actionGetCommentList()
    {
        if (EnvUtil::submitCheck("formhash")) {
            ...
            $widget = Ibos::app()->getWidgetFactory()->createWidget($this, "IWArticleComment", $properties);
    ...
    {
        if (EnvUtil::submitCheck("formhash")) {
            $widget = Ibos::app()->getWidgetFactory()->createWidget($this, "IWArticleComment");
