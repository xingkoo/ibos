				...
				<div class="art">
					<div class="art-container">
										...
										<div class="ad-thumbs">
											<ul class="ad-thumb-list">
												<?php foreach ( $pictureData as $key => $picture ): ?>
													<li>
														<a href="<?php echo FileUtil::fileName( $picture['filepath'] ); ?>">
															<img src="<?php echo FileUtil::fileName( $picture['filepath'] ); ?>" alt="<?php echo $picture['filename']; ?>" />
															<!-- 此处输出索引和总张数 -->
						...
						<?php if ( $this->getVoteInstalled() && $data['votestatus'] ): ?>
							<?php echo ICVote::getView( 'articleView' ); ?>
						<?php endif; ?>
						</div>
						<!-- <div class="noprint">
							...
							<div class="tab-content">
								...
								<?php if ( $data['commentstatus'] && $dashboardConfig['articlecommentenable'] ): ?>
									<div id="comment" class="comment fill-zn tab-pane active">
										<?php
										$this->widget( 'IWArticleComment', array(
											'module' => 'article',
											'table' => 'article',
											'attributes' => array(
