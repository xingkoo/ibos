				...
				<div id="wb_main" data-node-type="feedList">
					<div class="wb-ifview-box mpanel" data-node-type="feedBox" data-feed-id="<?php echo $fd['uid']; ?>">
						...
						<div class="wb-ifview-top rdt bdbs">
							...
							<div class="wb-info-ads clearfix">
								<div class="wb-info-from pull-left">
									<span><?php echo ConvertUtil::formatDate( $fd['ctime'], 'n月d日H:i' ); ?></span>
						...
						<?php if ( $fd['module'] == 'weibo' ): ?>
							<?php
							$this->widget( 'IWWeiboComment', array(
								'module' => $fd['module'],
								'table' => 'feed',
								'attributes' => array(
									'rowid' => $fd['feedid'],
...
<script type="text/javascript" src="<?php echo $moduleAssetUrl; ?>/js/wb.js"></script>
<script type="text/javascript" src="<?php echo $moduleAssetUrl; ?>/js/wbindex.js"></script>
