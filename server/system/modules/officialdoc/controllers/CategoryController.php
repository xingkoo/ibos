...
class OfficialdocCategoryController extends OfficialdocBaseController
{
    /**
     * 分类对象
     * @var object
    ...
    public function init()
    {
        if ($this->_category === null) {
            $this->_category = new ICOfficialdocCategory("OfficialdocCategory");
        }
    }
    ...
    public function actionAdd()
    {
        ...
        $newSortId = $sortId + 1;
        $ret = OfficialdocCategory::model()->add(array("sort" => $newSortId, "pid" => $pid, "name" => $name, "aid" => $aid), true);
