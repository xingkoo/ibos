...
<?php if (!empty($docs)) : ?>
				...
				<tr>
					<td>
						<div class="mbs">
							...
							<?php endif; ?>
							<a href="<?php echo Yii::app()->urlManager->createUrl("officialdoc/officialdoc/show", array("docid" => $doc["docid"]));?>" class="title xcm"><?php echo $doc["subject"];?></a>
						</div>
						<div class="fss tcm">
							<?php if ($doc["isSign"]) : ?>
								<span class="pull-right"><?php echo $lang["Sign in"];?> <?php echo date("n" . $lang["Month"] . "j" . $lang["Day"] . "H:i", $doc["sign"]["signtime"]);?></span>
							<?php endif; ?>
	...
	<div class="mbox-base">
		<div class="fill-hn xac">
			<a href="<?php echo Yii::app()->urlManager->createUrl("officialdoc/officialdoc/index");?>" class="link-more">
