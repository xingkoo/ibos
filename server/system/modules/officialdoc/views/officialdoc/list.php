	...
	<div class="mcr">
		...
		<div>
			<ul class="mnv nl clearfix">
				...
				<li <?php if ($type == "nosign") echo 'class="active"'; ?> >
				...
				<li <?php if ($type == "draft") echo 'class="active"'; ?> >
		...
		<div class="page-list">
			<div class="page-list-header">
				...
				<form  action="<?php echo $this->createUrl("officialdoc/index", array("param" => "search"));?>" method="post">
					<div class="search search-config pull-right span3">
						<input type="text" placeholder="输入标题查询" name="keyword"  id="mn_search" nofocus <?php if (EnvUtil::getRequest("param")) : ?>value="<?php echo MainUtil::getCookie("keyword");?>"<?php endif; ?> >
			...
			<div class="page-list-mainer art-list">
				<?php if (0 < count($officialDocList)) : ?>
						...
						<tbody>
							<?php foreach ($officialDocList as $officialDoc ) : ?>
								<tr data-node-type="docRow" data-id="<?php echo $officialDoc["docid"];?>">
									...
									<td>
										<i class="o-art-normal<?php if ($officialDoc["signStatus"] == 1) echo '-gray'; ?>"></i>
									</td>
									<td>
									...
									<td>
										...
										<div class="art-form-funbar">
											<a href="<?php echo $this->createUrl("officialdoc/edit", array("docid" => $officialDoc["docid"]));?>" title="<?php echo Ibos::lang("Edit");?>" target="_self" class="cbtn o-edit"></a>
											<?php if ($type != "notallow") : ?>
