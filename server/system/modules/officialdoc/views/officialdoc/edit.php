						...
						<div class="control-group">
							<div>
								<div class="btn-group btn-group-justified" data-toggle="buttons-radio" id="article_status">
									<label class="btn <?php if ($data["status"] == 2) : ?>active<?php endif; ?>">
										<input type="radio" name="status" value="2" <?php if ($data["status"] == 2) : ?>checked<?php endif; ?> >
										<?php echo Ibos::lang("Wait verify");?>
									</label>
									<label class="btn <?php if ($data["status"] == 1) echo "active"; ?>" <?php if (($data["status"] != 1) && !$allowPublish) echo 'style="display:none"';?> >
										<input type="radio" name="status" value="1" <?php if ($data["status"] == 1) echo "checked";?> >
										<?php echo Ibos::lang("Publish");?>
									</label>
									<label class="btn <?php if ($data["status"] == 3) echo "active"; ?>">
										<input type="radio" name="status" value="3" <?php if ($data["status"] == 3) echo "checked"; ?> >
