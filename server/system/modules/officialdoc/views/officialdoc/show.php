										...
										<div class="dib mls">
											<ul class="list-inline flow-ul">
												<?php for ($i = 1; $i <= $data["approval"]["level"]; $i++) : ?>
													<li>
														<?php if (1 < $i) : ?>
															<span class="<?php if ($i <= $data["stepNum"]) : ?>o-allow-line<?php else : ?>o-noallow-line";<?php endif; ?>"></span>
														<?php endif; ?>
														<span data-toggle="tooltip" data-original-title="审核人:<?php echo $data["approval"][$i]["approvaler"];?>" class="<?php if ($i <= $data["stepNum"]) : ?>o-allow-circle<?php else : ?>o-noallow-circle<?php endif; ?>"><?php echo 	$i;?></span>
													</li>
												<?php endfor; ?>
											</ul>
										</div>
								...
								<div class="noprint">
									...
									<div class="tab-content">
										...
										<?php if ($dashboardConfig["doccommentenable"] && $data["commentstatus"]) : ?>
											...
											<?php 
												$this->widget("IWOfficialdocComment", array(
													"module"     => "officialdoc",
													"table"      => "officialdoc",
													"attributes" => array(
														"rowid" => $data["docid"], 
