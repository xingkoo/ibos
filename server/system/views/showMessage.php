...
<html lang="en">
	<head>
		...
		<style>
			/* Status Tip */
			.status-tip i,.status-tip a {background-image: url(<?php echo STATICURL; ?>/image/status_tip.png);background-repeat: no-repeat;}
			...
			.status-tip a{display: block;height: 100px;width: 100%;background-position: 0 -80px;text-indent: -9999px;}
			...
			<div class="status-tip status-tip-<?php echo $messageType; ?>">
				...
				<?php else: ?>
					<?php foreach ( $jumpLinksOptions as $linkName => $url ): ?>
						<a href="<?php echo $url; ?>"><?php echo $linkName; ?></a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<?php endforeach; ?>
				<?php endif; ?>
			</div>
